<table cellspacing="0" cellpadding="0" class="packageTable">
	<thead>
		<tr>
			<th class="first" style="min-width: 193px; min-height: 101px;">&nbsp;</th>
			<th style="min-width: 158px;">Currencies</th>
			<th style="min-width: 165px;">Languages on payment page</th>
			<th style="min-width: 109px;">Mobile optimized payment page</th>
			<th style="min-width: 109px;">One click payment</th>
			<th style="min-width: 98px;">Recurring payment</th>
			<th style="min-width: 84px;">Full refund</th>
			<th style="min-width: 84px;">Partial refund</th>
			<th style="min-width: 148px;">Two-step payments (preauthorization)</th>
			<th style="min-width: 95px;">One to multiple payments</th>
			<th style="min-width: 105px;">Unique payment page design</th>
			<th style="min-width: 84px;">E-wallet</th>
			<th style="min-width: 109px;">MasterCard</th>
			<th style="min-width: 61px;">VISA</th>
			<th style="min-width: 84px;">Amex</th>
			<th style="min-width: 77px;">3D Secure</th>
			<th style="min-width: 104px;">SZÉP Card acceptance</th>
			<th style="min-width: 86px;">Bank account transfer</th>
			<th style="min-width: 150px;">providerName</th>
		</tr>
	</thead>
	<tbody>
		...
		<tr class="datarow odd">
			...
			<td>
				...
				<span>CHF, PLN, CZK</span>
			</td>
			<td>
				<div class="info">hu, en, de, ...</div>
				<span>es, fr, it, nl, pl, sk, cs</span>
			</td>
			<td class="check yes">&nbsp;</td>
			<td class="check no">&nbsp;</td>
			<td class="check no">&nbsp;</td>
...
$(document).ready(function() {
	$('.packageTable tbody').scroll(function(e) {
		$('.packageTable thead').css("left", -$(".packageTable tbody").scrollLeft());
		$('.packageTable thead th:nth-child(1)').css("left", $(".packageTable tbody").scrollLeft());
		$('.packageTable tbody td:nth-child(1)').css("left", $(".packageTable tbody").scrollLeft());
	});
});
</script>
